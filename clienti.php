  ...
  <div class="main-content">
    <div class="container-fluid">
      ...
      <div class="row mb-4">
        ...
        <div class="col-md-4">
          <div id="clientiMap" class="map-container shadow-sm"></div>
        </div>
      </div>
...
<script>
const clientiMapData = JSON.parse('<?php echo json_encode($clienti, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>');
let currentPage = 1;
